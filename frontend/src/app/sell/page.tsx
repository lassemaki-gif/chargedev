    ...
    <div>
      ...
      <div className="px-6 lg:px-16 py-20 max-w-3xl">
        ...
        <p className="text-ash text-lg leading-relaxed mb-10">
          If you have a three-phase socket or an existing EV charger at home, you can list it on Latauslasse
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-12">
          {[
            ...
            { icon: "💰", t: "You keep 80%", b: "Latauslasse takes a 20% platform fee. The rest is yours." },
